...
CREATE TABLE SpotifyClone.Albums (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (autor_id) REFERENCES SpotifyClone.Artists (id)
) ENGINE=InnoDB;
...
CREATE TABLE SpotifyClone.Music_users (
...
CREATE TABLE SpotifyClone.Artist_users (
	user_id INT NOT NULL,
...
INSERT INTO SpotifyClone.Albums (title, autor_id, release_year)
VALUES
('Envious', 1, 1990),
('Exuberant', 1, 1993),
...
INSERT INTO SpotifyClone.Musics (album_id, title, duration_sec)
VALUES
(1, "Soul For Us", 200),
...
INSERT INTO SpotifyClone.Artist_users (user_id, artist_id)
VALUE
(1,	1),
(1,	4),
(1,	3),
...
INSERT INTO SpotifyClone.Music_users (user_id, music_id, play_date)
VALUE
